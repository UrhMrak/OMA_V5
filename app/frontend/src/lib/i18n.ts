...
export const en = {
  ...
  library: {
    title: 'Music and Document Library',
  ...
  catalog: {
    ...
    count: 'Showing {from}\u2013{to} of {total} works',
    ...
    program: {
      ...
      findInLibraryAria: 'Find a library work for program row {number}',
      suggested: 'Suggested: {name}',
      accept: 'Use',
      acceptAria: 'Link program row {number} to {name}',
      pickerTitle: 'Find in library',
      pickerSearch: 'Search the library...',
...
export const is: Translations = {
  ...
  catalog: {
    ...
    count: 'S\u00FDnir {from}\u2013{to} af {total} verkum',
    pagePrevious: 'Fyrri s\u00ED\u00F0a',
    pageNext: 'N\u00E6sta s\u00ED\u00F0a',
    pageStatus: 'S\u00ED\u00F0a {page} af {pages}',
    ...
    program: {
      ...
      findInLibrary: 'Finna \u00ED safni',
      findInLibraryAria: 'Finna verk \u00ED safni fyrir l\u00EDnu {number}',
      suggested: 'Tillaga: {name}',
      accept: 'Nota',
      acceptAria: 'Tengja l\u00EDnu {number} vi\u00F0 {name}',
      pickerTitle: 'Finna \u00ED safni',
      pickerSearch: 'Leita \u00ED safni\u2026',
      pickerEmpty: 'Engin samsvarandi verk.',
      pickerSearching: 'Leitar\u2026',
