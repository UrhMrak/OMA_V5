...
export const en = {
  ...
  library: {
    ...
    uploadFailed: 'Upload failed. Only PDFs up to 25MB are allowed.',
    ...
    dropzone: 'Drag & drop PDFs here or click to select',
  },
  event: {
    create: 'Create Event',
...
export const is: Translations = {
  ...
  library: {
    ...
    uploadFailed: 'Upphle\u00F0sla mist\u00F3kst. A\u00F0eins PDF allt a\u00F0 25MB eru leyf\u00F0.',
    ...
    dropzone: 'Drag\u00F0u og slepptu PDF h\u00E9r e\u00F0a smelltu til a\u00F0 velja',
  },
  event: {
